...
public class Channel {
	...
	public boolean removeListener(BlockPos pos) {
	...
	public boolean removeSender(BlockPos pos) {
		Sender removedSender = senders.remove(pos);
		if (removedSender != null) {
			vpl.LOGGER.info("Removed sender for channel {} at pos {}", num, pos);
			return true;
		}
		vpl.LOGGER.warn("Attempted to remove non-existent sender for channel {} at pos {}", num, pos);
		return false;
	}
